...
class SessionServiceImplTest {
    ...
    void bookSession_setsRequestedStatus() {
        ...
        mentor.setSkills(java.util.List.of("Java", "Spring Boot"));

        when(mentorFeignClient.getMentorById(1L)).thenReturn(mentor);
    ...
    void bookSession_whenMentorNotApproved_throwsHelpfulException() {
        ...
        assertEquals("Mentor 1 cannot be booked because they are not approved yet (status: PENDING)", ex.getMessage());
    }
