...
public class UserServiceImpl implements UserService {
    ...
    public AuthResponse register(UserRequest userRequest) {
        ...
        String internalAccessToken = jwtService.generateToken(savedUser.getEmail(), savedUser.getRole().name());

        userServiceClient.createUser(
                "Bearer " + internalAccessToken,
                new UserServiceUserRequest(
                        savedUser.getName(),
                        savedUser.getEmail(),
                        normalizeRoleForUserService(savedUser.getRole().name())
                )
        );
        notificationServiceClient.sendNotification(
                ...
                NotificationRequestDto.builder()
                        ...
                        .message("Welcome to SkillSync, " + savedUser.getName() + ". Your account is ready to start learning, mentoring, and joining communities.")
    ...
    private String normalizeRoleForUserService(String authRole) {
        return authRole.replace("ROLE_", "");
    }
